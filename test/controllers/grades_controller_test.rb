...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { graduate_id: @grade.graduate_id, period: @grade.period, value: @grade.value }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { graduate_id: @grade.graduate_id, period: @grade.period, value: @grade.value }
    assert_redirected_to grade_path(assigns(:grade))
  end
